...
logger = setup_logger(debug=True if os.environ.get("dipperai_debug_model", None) else False)


def init_cache():
    """
    init cache file, if exist return, else create cache file;
    cache file path: {run-path}/.cache/dipperai.json
    :return:
    """
